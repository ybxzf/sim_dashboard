        ...
        <div class="flex-item">
            <div class="item-title">
                <span class="title-name">
                    {{ typeSelected === 'REAL_TIME' ? '储能监测' : '储能功率监测' }}
                </span>
    ...
    return {
        ...
        cont_data: [
            ...
            // }, {
                ...
                dataName: '总放电量',
                realData: realStore.realTimeData.energyTotalOut,
                unit: 'kWh'
            }, {
                iconName: 'daily_charge',
                dataName: '今日充电量',
                realData: realStore.realTimeData.energyInPower,
                unit: 'kWh'
            }, {
                iconName: 'daily_discharge',
                dataName: '今日放电量',
                realData: realStore.realTimeData.energyOutPower,
                unit: 'kWh'
            },
        ],
    }
